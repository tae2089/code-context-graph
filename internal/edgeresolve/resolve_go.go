...
func (goLanguageDispatch) CollectQualifiedCallCandidates(caller model.Node, callee string) []string {
...
func (goLanguageDispatch) EnsureDispatchTargets(caller *model.Node, callee string, st *resolveState) []string {
	if caller == nil {
		return nil
	}
	var names []string
...
func (goLanguageDispatch) ResolveSameReceiverCall(caller *model.Node, callee string, st *resolveState) *model.Node {
	if caller == nil {
		return nil
	}
...
func (goLanguageDispatch) ResolveInterfaceDispatch(caller *model.Node, callee string, st *resolveState) *model.Node {
	if caller == nil {
		return nil
	}
...
func (goLanguageDispatch) PackagePrefix(node model.Node) string {

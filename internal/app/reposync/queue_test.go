...
func (testObservability) Start(ctx context.Context, operation, repo, branch string) (context.Context, func()) {
	ctx, span := obs.StartChildSpan(ctx, operation, attribute.String("repo.full_name", repo), attribute.String("git.branch", branch))
	return ctx, func() { span.End() }
}

func (testObservability) LogArgs(context.Context) []any { return nil }

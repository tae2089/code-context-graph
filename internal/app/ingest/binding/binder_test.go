...
func TestBinder_FunctionWithPrecedingComment(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "AuthenticateUser", Kind: graph.NodeKindFunction, StartLine: 3, EndLine: 10},
	}
...
func TestBinder_ClassWithPrecedingComment(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "UserService", Kind: graph.NodeKindClass, StartLine: 6, EndLine: 20},
	}
...
func TestBinder_NoComment(t *testing.T) {
	b := NewBinder()
	nodes := []graph.Node{
		{Name: "Foo", Kind: graph.NodeKindFunction, StartLine: 5, EndLine: 10},
	}
...
func TestBinder_MultipleDeclarations(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "FuncA", Kind: graph.NodeKindFunction, StartLine: 2, EndLine: 4},
		{Name: "FuncB", Kind: graph.NodeKindFunction, StartLine: 7, EndLine: 9},
	}
...
"""`},
	...
	nodes := []graph.Node{
		{Name: "get_user", Kind: graph.NodeKindFunction, StartLine: 7, EndLine: 8},
	}
 ...
 */`},
	...
	nodes := []graph.Node{
		{Name: "UserService", Kind: graph.NodeKindClass, StartLine: 8, EndLine: 9},
	}
...
func TestBinder_RustAttributeGap_BindsWithinMaxGap(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "main", Kind: graph.NodeKindFunction, StartLine: 5, EndLine: 6},
	}
...
func TestBinder_CAttributeGap_BindsWithinMaxGap(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "add", Kind: graph.NodeKindFunction, StartLine: 6, EndLine: 8},
	}
...
func TestBinder_GapWithCodeBetween_NoBinding(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "BigClass", Kind: graph.NodeKindClass, StartLine: 8, EndLine: 20},
	}
...
func TestBinder_LookBetween_BlankLinesOnly_Binds(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "MyFunc", Kind: graph.NodeKindFunction, StartLine: 5, EndLine: 10},
	}
	sourceLines := []string{
...
func TestBinder_LookBetween_CodeBetween_NoBinding(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "MyFunc", Kind: graph.NodeKindFunction, StartLine: 3, EndLine: 10},
	}
	sourceLines := []string{
...
func TestBinder_LookBetween_WhitespaceOnlyLines_Binds(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "MyFunc", Kind: graph.NodeKindFunction, StartLine: 4, EndLine: 10},
	}
	sourceLines := []string{
...
func TestBinder_Passthrough_PythonDecorators_Binds(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "get_user", Kind: graph.NodeKindFunction, StartLine: 4, EndLine: 8},
	}
	sourceLines := []string{
...
func TestBinder_Passthrough_JavaAnnotations_Binds(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "UserService", Kind: graph.NodeKindClass, StartLine: 7, EndLine: 20},
	}
	sourceLines := []string{
		"/**",                        // line 1
...
func TestBinder_Passthrough_RustAttributes_Binds(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "main", Kind: graph.NodeKindFunction, StartLine: 5, EndLine: 10},
	}
	sourceLines := []string{
...
func TestBinder_Passthrough_CAttributes_Binds(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "add", Kind: graph.NodeKindFunction, StartLine: 6, EndLine: 10},
	}
	sourceLines := []string{
		"/**", // line 1
...
func TestBinder_Passthrough_Mixed_Binds(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "handler", Kind: graph.NodeKindFunction, StartLine: 6, EndLine: 10},
	}
	sourceLines := []string{
...
func TestBinder_Passthrough_DecoratorPlusCode_NoBinding(t *testing.T) {
	...
	nodes := []graph.Node{
		{Name: "handler", Kind: graph.NodeKindFunction, StartLine: 4, EndLine: 10},
	}
	sourceLines := []string{

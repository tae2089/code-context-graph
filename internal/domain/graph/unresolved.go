...
type UnresolvedEdgeCandidate struct {
	...
	Namespace   string   `gorm:"size:256;not null;default:'default';uniqueIndex:idx_unresolved_ns_fp"`
	LookupKey   string   `gorm:"size:512;not null;index"`
	Fingerprint string   `gorm:"type:text;not null;uniqueIndex:idx_unresolved_ns_fp"`

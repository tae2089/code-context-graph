...
`,
			symbolName:     "Greet",
			expectedKind:   graph.NodeKindFunction,
...
`,
			symbolName:     "User",
			expectedKind:   graph.NodeKindClass,
...
`,
			...
			expectedKind:   graph.NodeKindType,

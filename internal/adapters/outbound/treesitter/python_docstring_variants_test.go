...
func measureDocstringFixture(
	...
	for _, binding := range bindings {
		var matchName bool
		if targetSymName == "" {
			matchName = binding.Node.Kind == graph.NodeKindFile
		} else {
...
func TestPythonDocstring_FuncDouble(t *testing.T) {
	m := measureDocstringFixture(t, "docstring_func_double.py", "get_user", graph.NodeKindFunction)
...
func TestPythonDocstring_FuncSingle(t *testing.T) {
	m := measureDocstringFixture(t, "docstring_func_single.py", "get_user", graph.NodeKindFunction)
...
func TestPythonDocstring_OneLine(t *testing.T) {
	m := measureDocstringFixture(t, "docstring_oneline.py", "add", graph.NodeKindFunction)
...
func TestPythonDocstring_Class(t *testing.T) {
	m := measureDocstringFixture(t, "docstring_class.py", "User", graph.NodeKindClass)
...
func TestPythonDocstring_Module(t *testing.T) {
	...
	m := measureDocstringFixture(t, "docstring_module.py", "", graph.NodeKindFile)
...
func TestPythonDocstring_AllVariants_Summary(t *testing.T) {
	...
	cases := []fixtureCase{
		{"docstring_func_double.py", "get_user", graph.NodeKindFunction, "func+\"\"\""},
		{"docstring_func_single.py", "get_user", graph.NodeKindFunction, "func+'''"},
		{"docstring_oneline.py", "add", graph.NodeKindFunction, "oneliner"},
		{"docstring_class.py", "User", graph.NodeKindClass, "class"},
		{"docstring_module.py", "", graph.NodeKindFile, "module"},
	}
	...
	for _, tc := range cases {
		t.Run(tc.label, func(t *testing.T) {
			...
			for _, binding := range bindings {
				var match bool
				if tc.symName == "" {
					match = binding.Node.Kind == graph.NodeKindFile
				} else {
...
func TestPythonDocstring_GapAnalysis(t *testing.T) {
	...
	cases := []gapCase{
		...
		// → gap = get_user.StartLine - docstring.EndLine < 0 → 바인딩 불가능.
		{
			...
			symName:          "get_user",
			symKind:          graph.NodeKindFunction,
			fakeCommentStart: 4,
			fakeCommentEnd:   7,
		},

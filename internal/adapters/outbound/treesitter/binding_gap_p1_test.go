...
func TestWalkerBinder_P1_AllLanguages_Summary(t *testing.T) {
	cases := []p1Case{
		{"TypeScript/decorator", TypeScriptSpec, "typescript", "decorator_gap.ts", "UserService", graph.NodeKindClass, "decorator"},
		{"Kotlin/annotation", KotlinSpec, "kotlin", "AnnotationGap.kt", "Greeting", graph.NodeKindFunction, "annotation"},
		{"PHP/attribute", PHPSpec, "php", "attribute_gap.php", "getUser", graph.NodeKindFunction, "attribute"},
		{"C++/attribute", CppSpec, "cpp", "attribute_gap.cpp", "divide", graph.NodeKindFunction, "attribute"},
		{"Go/directive", GoSpec, "go", "directive_gap.go", "Pill", graph.NodeKindType, "directive"},
	}

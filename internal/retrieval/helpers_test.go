...
func TestGroupCandidatesByFile_order(t *testing.T) {
	nodes := []model.Node{
		{ID: 1, Kind: model.NodeKindFunction, FilePath: "a/b.go", Name: "Foo"},
		{ID: 2, Kind: model.NodeKindFunction, FilePath: "c/d.go", Name: "Bar"},
		{ID: 3, Kind: model.NodeKindFunction, FilePath: "a/b.go", Name: "Baz"},
	}
...
func TestGroupCandidatesByFile_limit(t *testing.T) {
	nodes := []model.Node{
		{ID: 1, Kind: model.NodeKindFunction, FilePath: "a.go", Name: "A"},
		{ID: 2, Kind: model.NodeKindFunction, FilePath: "b.go", Name: "B"},
		{ID: 3, Kind: model.NodeKindFunction, FilePath: "c.go", Name: "C"},
	}
...
func TestGroupCandidatesByFile_emptyFilePath(t *testing.T) {
	nodes := []model.Node{
		{ID: 1, Kind: model.NodeKindFunction, FilePath: "", Name: "NoPath"},
		{ID: 2, Kind: model.NodeKindFunction, FilePath: "a.go", Name: "A"},
	}
...
func TestGroupCandidatesByFile_skipsPackageNodes(t *testing.T) {
	nodes := []model.Node{
		{ID: 1, Kind: model.NodeKindPackage, FilePath: "internal/mcp", Name: "mcp"},
		{ID: 2, Kind: model.NodeKindFunction, FilePath: "internal/mcp/handler.go", Name: "Handler"},
	}
	groups, nodeIDs := retrieval.GroupCandidatesByFile(nodes, 10)
	if len(groups) != 1 {
...
func TestDBSummary_annotationSummaryFirst(t *testing.T) {
	ann := &model.Annotation{NodeID: 1, Summary: "my summary"}
	nodes := []model.Node{{ID: 1, Name: "Foo"}}
	annotations := map[uint]*model.Annotation{1: ann}
...
func TestDBSummary_fallbackToTagValue(t *testing.T) {
	ann := &model.Annotation{
		NodeID:  1,
		Summary: "",
		Tags:    []model.DocTag{{Kind: model.TagIntent, Value: "tag value"}},
	}
	nodes := []model.Node{{ID: 1, Name: "Foo"}}
	annotations := map[uint]*model.Annotation{1: ann}
	got := retrieval.DBSummary(nodes, annotations)
...
func TestDBSummary_noAnnotation(t *testing.T) {
	nodes := []model.Node{{ID: 1, Name: "Foo"}}
	annotations := map[uint]*model.Annotation{}
	got := retrieval.DBSummary(nodes, annotations)
	if got != "" {
...
func TestBuildDBResult_fieldsDefault(t *testing.T) {
	group := retrieval.DBFileGroup{
		FilePath: "pkg/foo.go",
		Nodes:    []model.Node{{ID: 1, Kind: model.NodeKindFunction, Name: "Foo", FilePath: "pkg/foo.go", QualifiedName: "pkg.Foo"}},
	}
	annotations := map[uint]*model.Annotation{}
...
func TestBuildDBResult_scoreDoesNotExposeResponseOrderTieBreaker(t *testing.T) {
	...
	second := retrieval.DBFileGroup{
		FilePath: "b.go",
		Nodes: []model.Node{
			{ID: 2, Kind: model.NodeKindFunction, Name: "B", FilePath: "b.go"},
			{ID: 3, Kind: model.NodeKindFunction, Name: "C", FilePath: "b.go"},
		},
	}
...
func TestDBMatches_deduplication(t *testing.T) {
	nodes := []model.Node{
		{ID: 1, Kind: model.NodeKindFunction, Name: "Foo", FilePath: "a.go", QualifiedName: "pkg.Foo"},
		{ID: 1, Kind: model.NodeKindFunction, Name: "Foo", FilePath: "a.go", QualifiedName: "pkg.Foo"},
	}
...
func TestDBMatches_annotationSummaryPreferred(t *testing.T) {
	ann := &model.Annotation{NodeID: 1, Summary: "annotated summary"}
	nodes := []model.Node{{ID: 1, Kind: model.NodeKindFunction, Name: "Foo", FilePath: "a.go", QualifiedName: "pkg.Foo", Annotation: ann}}
	matches := retrieval.DBMatches(nodes, nil)
	if len(matches) != 1 {
...
func TestDBMatches_batchAnnotationSummaryPreferred(t *testing.T) {
	nodes := []model.Node{{ID: 1, Kind: model.NodeKindFunction, Name: "Foo", FilePath: "a.go", QualifiedName: "pkg.Foo"}}
	annotations := map[uint]*model.Annotation{1: {NodeID: 1, Summary: "batch summary"}}
...
func TestNodeMatchesTerms_nameMatch(t *testing.T) {
	node := model.Node{Name: "AuthHandler", QualifiedName: "pkg.AuthHandler", FilePath: "auth.go"}
...
func TestNodeMatchesTerms_annotationMatch(t *testing.T) {
	ann := &model.Annotation{Summary: "handles payment processing"}
	node := model.Node{Name: "Foo", QualifiedName: "pkg.Foo", FilePath: "foo.go", Annotation: ann}
...
func TestNodeMatchesTerms_noMatch(t *testing.T) {
	node := model.Node{Name: "Foo", QualifiedName: "pkg.Foo", FilePath: "foo.go"}
